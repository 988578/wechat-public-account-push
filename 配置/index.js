export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID:"wx87e3c62d5c6bb334",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1e1f08c29b209d9ab388f5b3eafa8d12",
  ...
  USERS: [
    {
      ...
      id: "o5ugE55gHIbM89zY7jVvOt2rgGQk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "wTSy5SXzKf9q8A4AMUoqTPDgtWxJSnSiWHdOQ9vdHyw",
      // 所在省
      词：“贵州”，
      // 新历生日，仅绘制星座运势格式必须“
      horoscopeDate: '12-27',
